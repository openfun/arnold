...
class TestStringMethods(unittest.TestCase):
    ...
    test_structure = {
        u"cmd": [u"false"],
        u"end": u"2016-12-29 16:46:04.151591",
        "_ansible_no_log": False,
        u"stdout": u"",
        u"changed": True,
        "failed": True,
        u"delta": u"0:00:00.005046",
        u"stderr": u"",
        u"rc": 1,
        "invocation": {
        ...
        "stdout_lines": [],
        u"start": u"2016-12-29 16:46:04.146545",
        u"warnings": [],
    }
...
class CallbackModule(CallbackBase):
    ...
    def _get_duration(self):
        ...
        duration = (
            total_duration.microseconds / 1000 + total_duration.total_seconds() * 1000
        )
        return duration
    ...
    def _open_section(self, section_name):
        ...
        self.task_start_preamble = "[{}]{} {} ...".format(
            self.tark_started.strftime("%H:%M:%S"), prefix.encode("utf-8"), section_name
        ).encode("utf8")
    ...
    def v2_runner_on_failed(self, result, ignore_errors=False):
        ...
        self._emit_line("%s | FAILED | %dms" % (host_string, duration), color="red")
    ...
    def v2_runner_on_skipped(self, result):
        ...
        self._emit_line(
            "%s | SKIPPED | %dms" % (self._host_string(result), duration), color="cyan"
        )
